...
import { horizontalSwitching } from '@/variants'
...
function UploadBox({
  ...
  const handleFiles = useSyncCallback(() => {
    if (isLyricsEmpty) {
      //更新音频数据
  ...
  const handleUploadClick = useCallback(() => {
    lyricsContentListener()
    handleFiles()
  }, [lyricsContentListener, handleFiles])
  ...
  return (
        ...
        <div className={style.upload_box_contain}>
          <div className={style.occupy_contain}>
            <motion.div
              ...
              animate={{ overflow: isEnlarged ? 'visible' : 'hidden' }}
            >
              <AnimatePresence
                initial={false}
                mode="wait"
    ...
    //               className={[
    //                 style.upload_icon,
    //                 isMusicUpload ? style.upload_success : '',
    //               ].join(' ')}
    //             ></i>
    //             <input
    //               id="music-file"
    ...
    //           className={[
    //             style.upload_icon,
    //             isLyricsUpload ? style.upload_success : '',
    //           ].join(' ')}
    //         ></i>
    //         <input
    //           id="lyrics-file"
